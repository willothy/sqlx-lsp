...
mod tests {
    ...
    #[test]
    fn detects_sqlite_for_this_workspace() {
        // This crate itself depends on sqlx with the `sqlite` feature, which
        // makes it a real end-to-end fixture for resolved-feature detection.
